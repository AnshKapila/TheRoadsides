    ...
    <div className="flex flex-col pt-24 min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-[64px]">
            ...
            <div className="lg:col-span-7 flex flex-col gap-[32px] text-[16px] leading-[1.65] text-[var(--charcoal)]">
              ...
              <div className="bg-[var(--paper)] border border-[var(--line)] rounded-[3px] p-[32px] my-[16px]">
                ...
                <Link href="/insights" className="inline-flex items-center text-[var(--brick)] font-semibold hover:text-[var(--moss)] transition-colors">
      ...
      <section className="bg-[var(--charcoal)] py-[64px] px-[32px]">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-[32px] font-bold text-[var(--white)] tracking-tight mb-[24px] leading-[1.2]">
          ...
          <Link href="/get-involved" className="inline-flex items-center justify-center bg-[var(--moss)] text-[var(--paper)] px-[32px] py-[16px] rounded-[3px] hover:bg-[var(--brick)] transition-colors text-[16px] font-semibold min-h-[48px]">
            Get Involved Today <ArrowRight className="ml-2 w-4 h-4" />
          </Link>
        </div>
      </section>
    </div>
