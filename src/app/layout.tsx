  ...
  return (
    <html lang="en">
      <body className={`${jakarta.className} min-h-screen flex flex-col bg-[var(--paper)] text-[var(--charcoal)] overflow-x-hidden`}>
        ...
        {/* Footer */}
        <footer className="bg-[var(--charcoal)] text-[var(--paper)] py-[96px] pb-[32px]">
          <div className="container mx-auto px-[32px] max-w-7xl">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-[48px] mb-[64px]">
              ...
              <div>
                <h4 className="text-[var(--paper)] font-bold mb-[24px] tracking-[0.01em] uppercase text-[12px]">Explore</h4>
                <ul className="flex flex-col gap-[16px]">
                  <li><Link href="/about" className="text-[var(--paper)]/70 hover:text-[var(--primary-green)] transition-colors font-medium text-[16px]">About</Link></li>
                  <li><Link href="/founder" className="text-[var(--paper)]/70 hover:text-[var(--primary-green)] transition-colors font-medium text-[16px]">Founder</Link></li>
                  <li><Link href="/gallery" className="text-[var(--paper)]/70 hover:text-[var(--primary-green)] transition-colors font-medium text-[16px]">Gallery</Link></li>
                  <li><Link href="/insights" className="text-[var(--paper)]/70 hover:text-[var(--primary-green)] transition-colors font-medium text-[16px]">Insights</Link></li>
                </ul>
              </div>
              <div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center pt-[32px] border-t border-[var(--paper)]/10 text-[12px] font-medium text-[var(--paper)]/40 tracking-wide">
              ...
              <div className="flex gap-[24px] mt-[16px] md:mt-0">
                ...
                <a href="#" className="hover:text-[var(--paper)] transition-colors">Terms of Use</a>
              </div>
            </div>
          </div>
        </footer>
