        ...
        <div className="container mx-auto max-w-7xl flex flex-col gap-[64px]">
          ...
          <div id="donate" className="grid grid-cols-1 lg:grid-cols-2 gap-[48px] items-center">
            ...
            <div className="flex flex-col gap-[24px]">
              ...
              <Link href="/contact" className="inline-flex items-center gap-[8px] justify-center bg-[var(--primary-green)] text-[var(--charcoal)] px-[32px] py-[16px] rounded-[3px] hover:bg-[var(--brick)] transition-colors text-[16px] font-semibold min-h-[48px] w-fit"> Make a Donation <Wallet className="w-[18px] h-[18px]" strokeWidth={2.5} /></Link>
            </div>
          </div>
          ...
          <div id="volunteer" className="grid grid-cols-1 lg:grid-cols-2 gap-[48px] items-center">
            <div className="flex flex-col gap-[24px] order-2 lg:order-1">
              ...
              <Link href="/contact" className="inline-flex items-center gap-[8px] justify-center bg-[var(--charcoal)] text-[var(--paper)] px-[32px] py-[16px] rounded-[3px] hover:bg-[var(--primary-green)] transition-colors text-[16px] font-semibold min-h-[48px] w-fit"> Sign Up to Volunteer <Users className="w-[18px] h-[18px]" strokeWidth={2.5} /></Link>
            </div>
          ...
          <div id="partner" className="grid grid-cols-1 lg:grid-cols-2 gap-[48px] items-center">
            ...
            <div className="flex flex-col gap-[24px]">
              ...
              <Link href="/contact" className="inline-flex items-center gap-[8px] justify-center bg-[var(--charcoal)] text-[var(--paper)] px-[32px] py-[16px] rounded-[3px] hover:bg-[var(--primary-green)] transition-colors text-[16px] font-semibold min-h-[48px] w-fit"> Explore Partnerships <Handshake className="w-[18px] h-[18px]" strokeWidth={2.5} /></Link>
            </div>
          </div>
